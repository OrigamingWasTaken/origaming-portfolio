<script lang="ts">
  ...
  const projects = [
    {
      title: 'AppleBlox',
      description: 'A lightweight Roblox launcher',
      repoUrl: 'https://github.com/origaming/appleblox',
      techs: ['JavaScript', 'Electron']
    },
    {
      title: 'ce-discord-bot',
      description: 'Discord bot that notifies you of Minecraft events',
      repoUrl: 'https://github.com/origaming/ce-discord-bot',
      techs: ['JavaScript', 'Node.js', 'Discord.js']
    }
  ];
...
`;
        ...
        case 'about':
          output = "I'm Origaming (she/he) and I am a passionate fullstack developer! I know TypeScript, Bash, and Python, and hope to learn Rust in the future.\n\nBut coding and solving problems is not my only passion. I also love playing the drums and cycling ^_^.";
          break;
        ...
        case 'contact':
          output = 'GitHub: https://github.com/origaming\nEmail: contact@origaming.dev';
          break;
 ...
 ( o.o ) 
  > ^ <  
        ...
        case 'open photos':
          ...
          import('$lib/store/appStore').then(({ windowStore }) => {
...
<div class="terminal-content" bind:this={terminalElement} on:click={focusInput}>
  ...
  <div class="output about">
    <p>I'm Origaming (she/he) and I am a passionate fullstack developer! I know TypeScript, Bash, and Python, and hope to learn <span class="emoji">🦀</span> Rust in the future.</p>
    <p>But coding and solving problems is not my only passion. I also love playing the drums and cycling ^_^.</p>
  </div>
  ...
  <div class="output">
    <div class="tech-stack">
      {#each techStack as tech}
        <span class="tech-badge" data-category={tech.category}>{tech.name}</span>
      {/each}
    </div>
  </div>
